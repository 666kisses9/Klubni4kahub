...
hint.Position = UDim2.new(0, 20, 0, 340)
hint.Text = "👇 Нажмите на ссылку или на иконку 📋 чтобы скопировать"
...
local function copyToClipboard(text)
    local success, err = pcall(function()
        ...
        elseif clipboard then
            ...
            -- Альтернативный метод через TextService
...
-- Клик по ссылке
linkFrame.MouseButton1Click:Connect(function()
